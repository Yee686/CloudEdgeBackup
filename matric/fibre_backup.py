...
src_fold = "/sync_worker/matric/backup_test_data/fibre"
dst_fold = "rsync_backup@172.17.0.3::backup/fibre"
...
if __name__ == '__main__':
    ...
    log_path = log_fold + "fibre.txt"
    

    cmd = f"trickle -s -u 75 -d 75 rsync --stats -av {src_path} {dst_path} --password-file={password} --port=873 \
